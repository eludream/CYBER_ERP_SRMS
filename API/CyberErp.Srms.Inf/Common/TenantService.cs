...
namespace CyberErp.Srms.Inf.Common
{
    ...
    public class TenantService : ITenantService
    {
        ...
        public string? GetCurrentTenantId()
        {
            ...
            // Tenant identity is accepted only from the validated principal.
        ...
        public void ValidateTenantForDatabaseOperations()
        {
            ...
            if (tenant != null)
            {
                ...
                if (!_environment.IsDevelopment() && tenant.SubscriptionEndDate.HasValue && tenant.SubscriptionEndDate.Value < DateTime.UtcNow)
                {
