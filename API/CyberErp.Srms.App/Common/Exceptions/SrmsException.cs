...
namespace CyberErp.Srms.App.Common.Exceptions
{
    /// <summary>
    /// Base exception for all CyberErp.Srms application exceptions
    /// </summary>
    [Serializable]
    public class SrmsException : Exception
    {
        ...
        public SrmsException(string message, string errorCode)
            : base(message)
        {
            ErrorCode = errorCode;
        }

        public SrmsException(string message, Exception innerException)
            : base(message, innerException)
        {
            ErrorCode = "BB000";
        }

        public SrmsException(string message, string errorCode, Exception innerException)
            : base(message, innerException)
        {
            ErrorCode = errorCode;
        }

        protected SrmsException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
    ...
    /// </summary>
    [Serializable]
    public class NotFoundException : SrmsException
    {
    ...
    /// </summary>
    [Serializable]
    public class DuplicateException : SrmsException
    {
        public string ResourceType { get; }
    ...
    /// </summary>
    [Serializable]
    public class ValidationException : SrmsException
    {
    ...
    /// </summary>
    [Serializable]
    public class UnauthorizedException : SrmsException
    {
    ...
    /// </summary>
    [Serializable]
    public class DatabaseException : SrmsException
    {
    ...
    /// </summary>
    [Serializable]
    public class CircuitBreakerOpenException : SrmsException
    {
